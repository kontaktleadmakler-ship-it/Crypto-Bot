...
describe('KuCoin timestamp normalization', () => {
  test('treats Unix-second candles as fresh millisecond timestamps', () => {
    const now = Date.now();
    ...
    const result = validator.candles(candles, { timeframeMs: 15 * 60 * 1000, maxAgeMs: 30 * 60 * 1000, allowGaps: true });
